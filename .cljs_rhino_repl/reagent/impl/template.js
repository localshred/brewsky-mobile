...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__45782__auto__,writer__45783__auto__,opt__45784__auto__){
return cljs.core._write.call(null,writer__45783__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__50850 = o;
(G__50850[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__45113__auto__ = !((jsprops == null));
if(and__45113__auto__){
var and__45113__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__50858 = jsprops;
(G__50858["defaultValue"] = value);

(G__50858["onChange"] = ((function (G__50858,v,value,on_change){
return (function (p1__50856_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__50856_SHARP_);
});})(G__50858,v,value,on_change))
);
...
var vec__50865 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__50865,(0),null);
var id = cljs.core.nth.call(null,vec__50865,(1),null);
var class$ = cljs.core.nth.call(null,vec__50865,(2),null);
...
var jsprops = ({"argv": v});
var temp__6742__auto___50870 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6742__auto___50870 == null)){
} else {
var key_50871 = temp__6742__auto___50870;
(jsprops["key"] = key_50871);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__50873 = (new reagent.impl.template.NativeWrapper());
(G__50873["name"] = c);
...
var len__46346__auto___50879 = arguments.length;
var i__46347__auto___50880 = (0);
while(true){
if((i__46347__auto___50880 < len__46346__auto___50879)){
args__46353__auto__.push((arguments[i__46347__auto___50880]));

var G__50881 = (i__46347__auto___50880 + (1));
i__46347__auto___50880 = G__50881;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__46354__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50877){
var G__50878 = cljs.core.first.call(null,seq50877);
var seq50877__$1 = cljs.core.next.call(null,seq50877);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__50878,seq50877__$1);
});
...
break;
default:
var G__50885 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__50885;
continue;
...
var n__46146__auto___50888 = a.length;
var i_50889 = (0);
while(true){
if((i_50889 < n__46146__auto___50888)){
(a[i_50889] = reagent.impl.template.as_element.call(null,(a[i_50889])));

var G__50890 = (i_50889 + (1));
i_50889 = G__50890;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__46146__auto___50891 = a.length;
var i_50892 = (0);
while(true){
if((i_50892 < n__46146__auto___50891)){
var val_50893 = (a[i_50892]);
if((cljs.core.vector_QMARK_.call(null,val_50893)) && ((reagent.impl.template.key_from_vec.call(null,val_50893) == null))){
(o["no-key"] = true);
} else {
}

(a[i_50892] = reagent.impl.template.as_element.call(null,val_50893));

var G__50894 = (i_50892 + (1));
i_50892 = G__50894;
continue;
} else {
}
...
var ctx = ({});
var vec__50898 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__50898,(0),null);
var derefed = cljs.core.nth.call(null,vec__50898,(1),null);
...
var G__50902 = (cljs.core.count.call(null,argv) - first_child);
switch (G__50902) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__50902){
