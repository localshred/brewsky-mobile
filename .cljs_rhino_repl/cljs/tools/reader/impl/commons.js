...
var G__55424 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__55424;
continue;
} else {
return ch;
...
var vec__55428 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__55428,(0),null);
return (match === s);
});
...
var len__46346__auto___55433 = arguments.length;
var i__46347__auto___55434 = (0);
while(true){
if((i__46347__auto___55434 < len__46346__auto___55433)){
args__46353__auto__.push((arguments[i__46347__auto___55434]));

var G__55435 = (i__46347__auto___55434 + (1));
i__46347__auto___55434 = G__55435;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__46354__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq55431){
var G__55432 = cljs.core.first.call(null,seq55431);
var seq55431__$1 = cljs.core.next.call(null,seq55431);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__55432,seq55431__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__55436__delegate = function (rdr,_){
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,msg);
};
var G__55436 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__55437__i = 0, G__55437__a = new Array(arguments.length -  1);
while (G__55437__i < G__55437__a.length) {G__55437__a[G__55437__i] = arguments[G__55437__i + 1]; ++G__55437__i;}
  _ = new cljs.core.IndexedSeq(G__55437__a,0,null);
} 
return G__55436__delegate.call(this,rdr,_);};
G__55436.cljs$lang$maxFixedArity = 1;
G__55436.cljs$lang$applyTo = (function (arglist__55438){
var rdr = cljs.core.first(arglist__55438);
var _ = cljs.core.rest(arglist__55438);
return G__55436__delegate(rdr,_);
});
