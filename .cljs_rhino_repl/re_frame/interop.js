...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__50519 = cljs.core.instance_QMARK_;
var expr__50520 = reactive_val;
if(cljs.core.truth_(pred__50519.call(null,reagent.ratom.RAtom,expr__50520))){
return "ra";
} else {
if(cljs.core.truth_(pred__50519.call(null,reagent.ratom.RCursor,expr__50520))){
return "rc";
} else {
if(cljs.core.truth_(pred__50519.call(null,reagent.ratom.Reaction,expr__50520))){
return "rx";
} else {
if(cljs.core.truth_(pred__50519.call(null,reagent.ratom.Track,expr__50520))){
return "tr";
} else {
return "other";
}
