...
var vec__50092_50095 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_50096 = cljs.core.nth.call(null,vec__50092_50095,(0),null);
var only_after_50097 = cljs.core.nth.call(null,vec__50092_50095,(1),null);
var db_changed_QMARK__50098 = (!((only_before_50096 == null))) || (!((only_after_50097 == null)));
if(db_changed_QMARK__50098){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_50096);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_50097);
...
var map__50105 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__50105__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__50105__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__50113 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__50113__$1 = ((((!((map__50113 == null)))?((((map__50113.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50113.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50113):map__50113);
var coeffects = map__50113__$1;
var event = cljs.core.get.call(null,map__50113__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__46346__auto___50116 = arguments.length;
var i__46347__auto___50117 = (0);
while(true){
if((i__46347__auto___50117 < len__46346__auto___50116)){
args__46353__auto__.push((arguments[i__46347__auto___50117]));

var G__50118 = (i__46347__auto___50117 + (1));
i__46347__auto___50117 = G__50118;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__46354__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq50115){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50115));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__45125__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__46353__auto__ = [];
var len__46346__auto___50124 = arguments.length;
var i__46347__auto___50125 = (0);
while(true){
if((i__46347__auto___50125 < len__46346__auto___50124)){
args__46353__auto__.push((arguments[i__46347__auto___50125]));

var G__50126 = (i__46347__auto___50125 + (1));
i__46347__auto___50125 = G__50126;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__46354__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__50119_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__50120_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__50120_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq50121){
var G__50122 = cljs.core.first.call(null,seq50121);
var seq50121__$1 = cljs.core.next.call(null,seq50121);
var G__50123 = cljs.core.first.call(null,seq50121__$1);
var seq50121__$2 = cljs.core.next.call(null,seq50121__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__50122,G__50123,seq50121__$2);
});
