...
var args49708 = [];
var len__46346__auto___49711 = arguments.length;
var i__46347__auto___49712 = (0);
while(true){
if((i__46347__auto___49712 < len__46346__auto___49711)){
args49708.push((arguments[i__46347__auto___49712]));

var G__49713 = (i__46347__auto___49712 + (1));
i__46347__auto___49712 = G__49713;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args49708.length)].join('')));
