...
var len__46346__auto___50474 = arguments.length;
var i__46347__auto___50475 = (0);
while(true){
if((i__46347__auto___50475 < len__46346__auto___50474)){
args__46353__auto__.push((arguments[i__46347__auto___50475]));

var G__50476 = (i__46347__auto___50475 + (1));
i__46347__auto___50475 = G__50476;
continue;
} else {
}
break;
...
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(argseq__46354__auto__);
});

re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__50471){
...
var m = map__50472__$1;
var id = cljs.core.get.call(null,map__50472__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__50472__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__50472__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__6736__auto___50477 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),re_frame.interceptor.mandatory_interceptor_keys));
if(temp__6736__auto___50477){
var unknown_keys_50478 = temp__6736__auto___50477;
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor ",m," has unknown keys:",unknown_keys_50478);
} else {
}
} else {
}

return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__45125__auto__ = id;
...
re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq50470){
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50470));
});

re_frame.interceptor.get_effect = (function re_frame$interceptor$get_effect(var_args){
var args50479 = [];
var len__46346__auto___50482 = arguments.length;
var i__46347__auto___50483 = (0);
while(true){
if((i__46347__auto___50483 < len__46346__auto___50482)){
args50479.push((arguments[i__46347__auto___50483]));

var G__50484 = (i__46347__auto___50483 + (1));
i__46347__auto___50483 = G__50484;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args50479.length)].join('')));
...
var args50486 = [];
var len__46346__auto___50489 = arguments.length;
var i__46347__auto___50490 = (0);
while(true){
if((i__46347__auto___50490 < len__46346__auto___50489)){
args50486.push((arguments[i__46347__auto___50490]));

var G__50491 = (i__46347__auto___50490 + (1));
i__46347__auto___50490 = G__50491;
continue;
} else {
}
break;
...
var args__46353__auto__ = [];
var len__46346__auto___50497 = arguments.length;
var i__46347__auto___50498 = (0);
while(true){
if((i__46347__auto___50498 < len__46346__auto___50497)){
args__46353__auto__.push((arguments[i__46347__auto___50498]));

var G__50499 = (i__46347__auto___50498 + (1));
i__46347__auto___50498 = G__50499;
continue;
} else {
}
break;
...
return re_frame.interceptor.update_coeffect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__46354__auto__);
});
...
re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq50493){
...
var G__50496 = cljs.core.first.call(null,seq50493__$2);
var seq50493__$3 = cljs.core.next.call(null,seq50493__$2);
return re_frame.interceptor.update_coeffect.cljs$core$IFn$_invoke$arity$variadic(G__50494,G__50495,G__50496,seq50493__$3);
});
...
var G__50500 = re_frame.interceptor.invoke_interceptor_fn.call(null,cljs.core.assoc.call(null,context__$1,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.pop.call(null,queue),new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.conj.call(null,stack,interceptor)),interceptor,direction);
context__$1 = G__50500;
continue;
}
break;
}
...
var args50501 = [];
var len__46346__auto___50504 = arguments.length;
var i__46347__auto___50505 = (0);
while(true){
if((i__46347__auto___50505 < len__46346__auto___50504)){
args50501.push((arguments[i__46347__auto___50505]));

var G__50506 = (i__46347__auto___50505 + (1));
i__46347__auto___50505 = G__50506;
continue;
} else {
}
break;
